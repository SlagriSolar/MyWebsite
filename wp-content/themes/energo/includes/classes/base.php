...
use ENERGO\Includes\Classes\Header_Enqueue;
use ENERGO\Includes\Classes\Options;
...
class Base {
	...
	public static function instance() {
		...
		if ( isset( $GLOBALS['energo_base'] ) ) {
			return $GLOBALS['energo_base'];
		}
	...
	function option( $key = '' ) {
		...
		$options = (array) get_theme_mod( 'energo' . '_options-mods' );

		$dn = energo_dot( $options );
