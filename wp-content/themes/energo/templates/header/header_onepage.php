...
//Logo V2
$logo = $options->get( 'logo_v4' );
$logo_dimension = $options->get( 'logo_v4_dimension' );

//Mobile Logo
$mobile_logo = $options->get( 'mobile_logo_v4' );
$mobile_logo_dimension = $options->get( 'mobile_logo_v4_dimension' );
			...
			<div class="top-inner clearfix">
				<div class="left-column pull-left">
					<ul class="info-list clearfix">
						...
						<li class="support-box">
							...
							<h6><?php echo wp_kses($options->get('phone_title_v4'), $allowed_html); ?> <a href="tel:<?php echo esc_attr(phone_number($options->get('phone_number_v4'))); ?>"><?php echo wp_kses($options->get('phone_number_v4'), $allowed_html); ?></a></h6>
						</li>
						<?php } ?>
						
						<?php if( $options->get('show_address_v4') ){ ?>
						<li>
							<i class="far fa-map"></i>
							<h6><?php echo wp_kses($options->get('address_v4'), $allowed_html); ?></h6>
						</li>
						<?php } ?>
						...
						<li>
							...
							<h6><?php echo wp_kses($options->get('working_hours_v4'), $allowed_html); ?></h6>
						</li>
						<?php } ?>
					</ul>
				</div>
				<div class="right-column pull-right">
					<ul class="other-links clearfix">
						<?php if( $options->get('show_help_button_v4') ){ ?>
						<li><i class="fas fa-star"></i><a href="<?php echo esc_url($options->get('help_button_link_v4')); ?>"><?php echo wp_kses($options->get('help_button_name_v4'), $allowed_html); ?></a></li>
						<?php } ?>
						
						<?php if( $options->get('show_setting_button_v4') ){ ?>
						<li><a href="<?php echo esc_url($options->get('setting_button_link_v4')); ?>"><?php echo wp_kses($options->get('setting_button_name_v4'), $allowed_html); ?></a></li>
						<?php } ?>
						
						<?php if( $options->get('show_media_button_v4') ){ ?>
						<li><a href="<?php echo esc_url($options->get('media_button_link_v4')); ?>"><?php echo wp_kses($options->get('media_button_name_v4'), $allowed_html); ?></a></li>
						<?php } ?>
					</ul>
				</div>
			</div>
			...
			<div class="outer-box clearfix">
				...
				<div class="nav-right pull-right clearfix">
					...
					<div class="search-box-outer">
						<div class="dropdown">
							<button class="search-box-btn" type="button" id="dropdownMenu3" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fas fa-search"></i><?php echo wp_kses($options->get('search_text_v4'), $allowed_html); ?></button>
					...
					<div class="btn-box">
						<a href="<?php echo esc_url($options->get('button_link_v4')); ?>"><i class="flaticon-right-arrow"></i><?php echo wp_kses($options->get('button_name_v4'), $allowed_html); ?></a>
					</div>
					<?php } ?>
				</div>
			</div>
		...
		<div class="sticky-header">
			<div class="outer-box">
				...
				<div class="nav-right pull-right clearfix">
					...
					<div class="search-box-outer">
						<div class="dropdown">
							<button class="search-box-btn" type="button" id="dropdownMenu4" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fas fa-search"></i>Search</button>
		...
		<nav class="menu-box">
			...
			<div class="contact-info">
				...
				<ul>
					...
					<li><a href="tel:<?php echo esc_attr(phone_number($options->get('mobile_phone_number_v4'))); ?>"><?php echo wp_kses($options->get('phone_title_v4'), $allowed_html); ?></a></li>
					<?php } ?>
					
					<?php if( $options->get('mobile_email_address_v4') ){ ?>
					<li><a href="mailto:<?php echo wp_kses($options->get('mobile_email_address_v4'), $allowed_html); ?>"><?php echo wp_kses($options->get('phone_title_v4'), $allowed_html); ?></a></li>
					<?php } ?>
				</ul>
			</div>
