...
class shams_solar_Icon_Changer extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <ul class="icon-list clearfix">
                    ...
                    <?php
                    $shams_solar_Icon_Changer_array = shams_solar_Icon_Changer_array();
                    foreach ($shams_solar_Icon_Changer_array as $shams_solar_Icon_Changer) {
                            $icon_class = $this->value() == $shams_solar_Icon_Changer ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($shams_solar_Icon_Changer).'"></i>
                            <span class="shams-solar-social-class">'.esc_attr($shams_solar_Icon_Changer).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function shams_solar_icon_customize_js() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'shams-solar-customize-icon', esc_url(get_template_directory_uri()).'/assets/js/customize-icon.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'shams_solar_icon_customize_js' );

if(!function_exists('shams_solar_Icon_Changer_array')){
    function shams_solar_Icon_Changer_array(){
        return array("", 
        "fab fa-500px",
